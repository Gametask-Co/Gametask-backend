...
export class CreatingMilestoneFields1605624470266 implements MigrationInterface {
    name = 'CreatingMilestoneFields1605624470266'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "milestones" ADD "name" character varying NOT NULL`);
