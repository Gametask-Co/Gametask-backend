...
export class CreatingTaskFields1605624701726 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tasks" ADD "attachment_url" character varying`);
        await queryRunner.query(`ALTER TABLE "tasks" ADD "total_score" integer NOT NULL DEFAULT 0`);
    }
