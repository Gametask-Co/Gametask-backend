...
export default class CreatingSubjectIdField1605627268600
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "milestones" RENAME COLUMN "subjectId" TO "subject_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "milestones" ALTER COLUMN "subject_id" SET NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "milestones" ALTER COLUMN "subject_id" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "milestones" RENAME COLUMN "subject_id" TO "subjectId"`,
    );
    await queryRunner.query(
